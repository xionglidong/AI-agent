...
一个基于 Mastra 框架的智能代码审查与优化助手，通过**AI聊天界面**提供自然语言交互的代码分析、优化、解释和审查服务。用户可以像与专业程序员对话一样，轻松获得代码质量分析、安全检查和性能优化建议。

## 🚀 功能特性

- 🤖 **AI聊天界面** - 类ChatGPT的对话式交互，自然语言描述需求
- 🧠 **智能意图识别** - 自动理解用户想要分析、优化、解释还是审查代码  
- 💬 **多种交互方式** - 支持文本输入、代码块、文件上传等多种方式
- 🔍 **智能代码分析** - 基于 AI 的深度代码审查和问题检测
- 🚀 **代码优化建议** - AI驱动的性能优化和代码重构建议
- 📚 **代码解释教学** - 详细解释代码逻辑和编程概念，支持不同难度级别
- 📁 **项目整体审查** - 全面分析项目结构、依赖和代码质量
- 🔒 **安全漏洞检测** - 识别常见的安全风险和漏洞
- ⚡ **性能分析** - 检测性能瓶颈并提供优化方案
- ☁️ **云端部署** - 支持Cloudflare Pages免费部署
